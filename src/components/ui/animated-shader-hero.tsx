...
// Reusable Shader Background Hook — renders an ambient, generative WebGL2
// canvas. Skips the render loop entirely under prefers-reduced-motion.
...
const badgeIconColors = ['text-yellow-300', 'text-orange-300', 'text-amber-300']
  ...
  return (
    <div className={`relative w-full h-screen overflow-hidden bg-black ${className}`}>
      <style>{`
        ...
        .shader-hero-fade-in-down { animation: shader-hero-fade-in-down 0.8s ease-out forwards; }
        .shader-hero-fade-in-up { animation: shader-hero-fade-in-up 0.8s ease-out forwards; opacity: 0; }
        ...
        @media (prefers-reduced-motion: reduce) {
          .shader-hero-fade-in-down, .shader-hero-fade-in-up { animation: none; opacity: 1; transform: none; }
        }
      `}</style>
      ...
      <div className="absolute inset-0 z-10 flex flex-col items-center justify-center text-white">
              ...
              {trustBadge.icons && (
                <div className="flex">
                  {trustBadge.icons.map((icon, index) => (
                    <span key={index} className={badgeIconColors[index % badgeIconColors.length]}>
                      {icon}
                    </span>
                  ))}
                </div>
        ...
        <div className="text-center space-y-6 max-w-5xl mx-auto px-4">
          <div className="space-y-2">
            <h1 className="text-5xl md:text-7xl lg:text-8xl font-bold bg-gradient-to-r from-orange-300 via-yellow-400 to-amber-300 bg-clip-text text-transparent shader-hero-fade-in-up shader-hero-delay-200">
              {headline.line1}
            </h1>
            <h1 className="text-5xl md:text-7xl lg:text-8xl font-bold bg-gradient-to-r from-yellow-300 via-orange-400 to-red-400 bg-clip-text text-transparent shader-hero-fade-in-up shader-hero-delay-400">
              {headline.line2}
            </h1>
          </div>
